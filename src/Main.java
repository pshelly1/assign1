...
public class Main
{
    public static void main(String[] args)
    {
        ...
        angleElevation=0.4699;//0.4699 radians =0.00814;
            buildingHeight=50;
         
        System.out.println("Let's roughly compute the height of a building.");
        System.out.println("Assume you are standing 20ft away.");
        System.out.print("What is the building height in meters?");
        System.out.print("What is the building height in feet?");
        System.out.print("Lookimg at the top, what is the angle of elevation?");
